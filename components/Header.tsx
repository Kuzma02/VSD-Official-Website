    ...
    return <header>
        <div className={"bg-white "}>
            <Link href={"/home"}>
                <p className={"text-xl font-bold text-center flex gap-2 items-center justify-center h-12 uppercase max-sm:text-lg"}>Go
                    to
                    the website in English <Image src="/english icon.png" alt={"english language"} width={30}
                                                  height={30}
        ...
        <nav
            ...
            <Link href={"https://www.gumenepatosnice.rs"}
                  className={"uppercase font-bold text-2xl max-md:text-xl max-sm:text-lg max-sm:hidden"}>internet
                prodavnica</Link>
            <Link href={"/o-nama"}
